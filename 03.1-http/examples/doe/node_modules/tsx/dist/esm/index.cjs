"use strict";var M=require("worker_threads"),P=require("../node-features-fa497138.cjs"),O=require("module"),v=require("../source-map.cjs"),l=require("path"),h=require("url"),R=require("../index-5d1f01e6.cjs"),L=require("../resolve-ts-path-3fca13b7.cjs"),N=require("../client-2f0df4a6.cjs"),p=require("get-tsconfig"),E=require("fs");require("esbuild"),require("crypto"),require("os"),require("../temporary-directory-2a027842.cjs"),require("net"),require("../get-pipe-path-86e97fc9.cjs");var f=typeof document<"u"?document.currentScript:null;const D=()=>{v.installSourceMapSupport(),O.register("./index.mjs",{parentURL:typeof document>"u"?require("url").pathToFileURL(__filename).href:f&&f.src||new URL("esm/index.cjs",document.baseURI).href,data:!0})},d=new Map;async function b(e){if(d.has(e))return d.get(e);if(!await E.promises.access(e).then(()=>!0,()=>!1)){d.set(e,void 0);return}const r=await E.promises.readFile(e,"utf8");try{const n=JSON.parse(r);return d.set(e,n),n}catch{throw new Error(`Error parsing: ${e}`)}}async function x(e){let t=new URL("package.json",e);for(;!t.pathname.endsWith("/node_modules/package.json");){const r=h.fileURLToPath(t),n=await b(r);if(n)return n;const a=t;if(t=new URL("../package.json",t),t.pathname===a.pathname)break}}async function A(e){var t;const r=await x(e);return(t=r==null?void 0:r.type)!=null?t:"commonjs"}const m=process.env.TSX_TSCONFIG_PATH?{path:l.resolve(process.env.TSX_TSCONFIG_PATH),config:p.parseTsconfig(process.env.TSX_TSCONFIG_PATH)}:p.getTsconfig(),I=m&&p.createFilesMatcher(m),q=m&&p.createPathsMatcher(m),S="file://",g=/\.([cm]?ts|[tj]sx)($|\?)/,J=/\.json(?:$|\?)/,C=e=>{const t=l.extname(e);if(t===".json")return"json";if(t===".mjs"||t===".mts")return"module";if(t===".cjs"||t===".cts")return"commonjs"},W=e=>{const t=C(e);if(t)return t;if(g.test(e))return A(e)},k=v.installSourceMapSupport(),U=/\/(?:$|\?)/,G=async e=>{if(!e)throw new Error(`tsx must be loaded with --import instead of --loader
The --loader flag was deprecated in Node v20.6.0`)},H=()=>`
