"use strict";var n=require("repl"),c=require("./package-2fc9fdf9.cjs"),l=require("./index-5d1f01e6.cjs");require("url"),require("esbuild"),require("crypto"),require("fs"),require("path"),require("os"),require("./temporary-directory-2a027842.cjs"),console.log(`Welcome to tsx v${c.version} (Node.js ${process.version}).
